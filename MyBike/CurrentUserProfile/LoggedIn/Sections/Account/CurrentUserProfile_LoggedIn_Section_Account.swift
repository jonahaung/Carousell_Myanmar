...
struct CurrentUserProfile_LoggedIn_Section_Account: View {
    ...
    private var ratingSection: some View {
        HStack(spacing: 15) {
            Person_Profile_Rating(personViewModel: currentUserViewModel)
        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            HStack {
                ...
                Text("Account Settings")
                    .tapToPush(CurrentUserProfile_LoggedIn_Section_Account_Update().environmentObject(currentUserViewModel).anyView)
            }
